...
// APIClient manages communication with the vRealize Network Insight API Reference API v1.1.8
...
type APIClient struct {
	...
	MicrosegmentationApi *MicrosegmentationApiService
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.MicrosegmentationApi = (*MicrosegmentationApiService)(&c.common)
...
func (c *APIClient) prepareRequest(
	...
	if ctx != nil {
		...
		if auth, ok := ctx.Value(ContextAccessToken).(string); ok {
			localVarRequest.Header.Add("Authorization", "NetworkInsight "+auth)
		}
